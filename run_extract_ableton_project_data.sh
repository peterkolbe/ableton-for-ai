...
# Run the extraction command using uv
echo "Executing PROJECT DATA EXTRACTION (metadata only)..."
...
echo "Project data extraction completed. osc_daemon.py is still running with PID $DAEMON_PID."
